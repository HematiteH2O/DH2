...
export const Formats: FormatList = [
	...
	/* // note from Hematite: commenting this out for the moment because I want to see what happens if it doesn't inherit from main M4A - will rework later to not require that
	{
