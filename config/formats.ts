...
export const Formats: FormatList = [
	...
	{
		name: "[Gen 8] Megas for All: Paldea",
		desc: ["<b>Megas for All</b>: A Pet Mod that aims to create unique Mega Evolutions for every fully evolved Pokémon. Current season is focused on the Paldea dex!",
		      ],
		threads: [
		...
		ruleset: ['Standard NatDex', 'Z-Move Clause', 'Terastal Clause', 'Dynamax Clause', 'Mega Data Mod'],
		// does this already include Sleep Clause I hope so
		banlist: [
 ...
 */
	{
		...
		desc: ["<b>Megas for All</b>: A Pet Mod that aims to create unique Mega Evolutions for every fully evolved Pokémon. A previous season focused on the Kalos dex!",
		      ],
		threads: [
				`&bullet; <a href="https://www.smogon.com/forums/threads/3671140/">Megas for All v7 on Smogon Forums</a>`,
				`&bullet; <a href="https://docs.google.com/spreadsheets/d/1TdeAUUtjh0f_tcIBllbF_imgepwV-dV2YomoTCRlPgI/edit?usp=sharing">Spreadsheet</a>`,
	...
	},
	{
		...
		banlist: [
			'Koraidon', 'Miraidon',
			// note to self: the only way Terapagos gets added is if it has a Mega anyway, so it would be allowed
		],
		onValidateTeam(team, format) {
			/**@type {{[k: string]: true}} */
			let speciesTable = {};
