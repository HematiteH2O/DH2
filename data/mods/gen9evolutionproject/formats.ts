...
export const Formats: FormatData[] = [
	{
		...
		// If you choose not to enter a team, the validator waves you through amyway; then, getTeam in scripts.ts provides one
		// This makes asymmetrical randbats possible: one player can bring a team they built themself, and the other can have a randomly-generated sample every time
		teamOptional: true,
