...
export const Formats: FormatData[] = [
	{
		...
		// "format.team" lets you enter without having a team
		// but normally, validateTeam then rejects any actual team\
		// here, I'm trying to modify validateTeam so it doesn't reject an actual team, either
		// buuut I don't want "format.team" to have any actual information, just in case I can stop it from imposing randoms on everyone?
		validateTeam (team, options) {
			...
			*/
			if (!team) {
				return [
					`Okay - so you don't have a team, but if this message displays, you're modding this correctly?`,
				];
			}
