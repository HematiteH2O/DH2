...
export const Formats: FormatData[] = [
	{
		...
		validateTeam(this, team, options) {
			if (team) {
				return [`Okay so this does override the team validator and you oo have a team`];
			} else {
				return [`Okay so this does override the team validator and you don't have a team`];
			}
